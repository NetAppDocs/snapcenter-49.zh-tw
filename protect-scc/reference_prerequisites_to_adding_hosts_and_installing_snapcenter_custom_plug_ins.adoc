...
** 對於 Windows 主機、 SHA512 雜湊位於
_C ： \Program Files\NetApp\SnapCenter 外掛程式 Creator\etc\custom_plugin_checksum _list.txt_
+
...
+
https://imt.netapp.com/matrix/imt.jsp?components=112392;&solution=1259&isHWU&src=IMT["NetApp 互通性對照表工具"]
