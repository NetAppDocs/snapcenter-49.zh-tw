...
+
您可以執行Get-Help _command_name_來取得可搭配Cmdlet使用之參數及其說明的相關資訊。或者、您也可以參閱 https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.html["Cmdlet參考指南"^]
...
** Linux ： /var/opt/2/SCC/allowed_commands.config SnapCenter
...
+
選取image:../media/filter_icon.gif["篩選圖示"]，然後選取主機名稱和資源類型以篩選資源。接著您可以選取 image:../media/filter_icon.gif["篩選圖示"] 以關閉篩選窗格。
