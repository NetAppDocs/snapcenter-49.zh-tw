...
image::../media/sce_backup_workflow.gif[Exchange Server 資料庫備份工作流程]

您也可以手動或在指令碼中使用PowerShell Cmdlet來執行備份、還原及複製作業。SnapCenter Cmdlet 說明或包含 PowerShell Cmdlet https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.html["《軟件指令程式參考指南》SnapCenter"^] 的詳細資訊。
