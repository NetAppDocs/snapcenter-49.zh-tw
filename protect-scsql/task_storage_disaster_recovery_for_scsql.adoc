...
.開始之前
* 確認外掛程式處於維護模式。
* 打破SnapMirror/SnapVault關係。
link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.onc-sm-help-950/GUID-8A3F828F-CD3D-48E8-A171-393581FEB2ED.html["打破SnapMirror關係"]
...
+
如需詳細資訊、請參閱 https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.html["《軟件指令程式參考指南》SnapCenter"^]。
